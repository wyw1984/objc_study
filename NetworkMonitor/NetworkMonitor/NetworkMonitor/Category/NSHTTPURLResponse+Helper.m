...
@implementation NSHTTPURLResponse (Helper)

+ (void)load {
    [HLLHooker hookInstance:@"NSHTTPURLResponse" sel:@"allHeaderFields" withClass:@"NSHTTPURLResponse" andSel:@"hook_allHeaderFields"];
}
